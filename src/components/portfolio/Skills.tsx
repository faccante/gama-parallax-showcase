  ...
  return (
    <section id="skills" className="py-40 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-24 scroll-animate" data-parallax="0.15">
          <h2 className="text-4xl md:text-5xl font-bold glass-text mb-8">Skills & Technologies</h2>
          <div className="glass-morphism p-10 rounded-2xl mx-4">
            <h3 className="text-xl md:text-2xl font-semibold glass-text mb-4">Technical Expertise</h3>
